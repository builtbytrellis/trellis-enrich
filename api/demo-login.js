...
const SAMPLE_CONTACTS = [
  { full_name: 'Gal Hirsch', email: '', phone: '', job_title: 'Realtor & Marketing Specialist', company: '', city: 'Toronto', suggested_tags: ['Sphere', 'Profession: Real Estate Agent', 'Profession: Marketing', 'Age: 30s', 'Life Stage: Young Professional'], notes: 'Toronto-based realtor with a strong marketing background. Active in the real estate tech space. Medium confidence based on limited public search results.' },
  { full_name: 'Dustin Seidler', email: 'dustin@dustinseidler.ca', phone: '416-200-7177', job_title: 'Sales Representative', company: 'Chestnut Park Real Estate', city: 'Toronto', suggested_tags: ['Sphere', 'Profession: Real Estate Agent', 'Age: 30s', 'Has Referred'], notes: 'Realtor at Chestnut Park Real Estate - Christies International affiliate. Former paramedic — head medic for the Toronto Raptors and Blue Jays. Yorkville specialist. Strong referral potential.' },
