...
const SAMPLE_CONTACTS = [
  { full_name: 'Gal Hirsch', email: 'gal@trellis.ai', phone: '', job_title: 'Founder', company: 'Trellis', city: 'Toronto', suggested_tags: ['Sphere', 'Profession: Tech', 'Age: 30s', 'Life Stage: Young Professional'], notes: 'Founder of Trellis. Building EmmieAI and the future of real estate operations. Connected to multiple agents across Toronto.' },
  { full_name: 'Dustin Seidler', email: 'dustin@dustinseidler.ca', phone: '416-200-7177', job_title: 'Sales Representative', company: 'Chestnut Park Real Estate', city: 'Toronto', suggested_tags: ['Sphere', 'Profession: Real Estate Agent', 'Age: 30s', 'Has Referred'], notes: 'Realtor at Chestnut Park Real Estate (Christie's International affiliate). Former paramedic — head medic for the Toronto Raptors and Blue Jays. Yorkville specialist. Strong referral potential.' },
