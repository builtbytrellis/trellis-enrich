...
async function createEmailTemplates(targetKey) {
  ...
  const templates = [
    ...
    { name: "Next Steps: Seller - Pre-Listing Freehold", subject: "Next Steps: Getting Your Home Ready for Market", body: `<p>Hi %contact_rels_first_name%,</p><p>Getting close! Before we go live on [DATE] there are a few things we need to wrap up. Please let me know what date you think you will be ready to list so I can get everything ready on my end.</p><p><strong>1. Information Form</strong></p><p>This form covers the basic information we need to prepare your listing paperwork. You will review and sign everything before it is finalized. Please click <a href='[GOOGLE FORM LINK]'>here</a> to fill it out online.</p><p><strong>2. Coming Soon Sign</strong></p><p>We will install a coming soon sign 1 week before going live on MLS to build excitement before launch.</p><p><strong>3. Pre-List Home Inspection</strong></p><p>I want to arrange a pre-list home inspection to avoid conditional offers on offer night. About 2 hours, needs access to interior and exterior. Let me know when works.</p><p><strong>4. Sellers Schedule / Workback</strong></p><p>I have prepared a sellers schedule so we can work together to get your home ready for sale. Please review and update it as things get done.</p><p><strong>5. Lawyer and Mortgage Broker</strong></p><p>Please send me the contact info for your lawyer and mortgage broker so I can send documents as soon as needed. Happy to provide recommendations.</p><p><strong>6. Prospect Match</strong></p><p>You are set up to receive alerts for comparable homes listing near [ADDRESS].</p><p>Take your time and reach out any time.</p><p>Talk soon,<br>%agent_first_name% %agent_last_name%<br>%agent_phone%<br>%agent_email%</p>` },
    ...
    { name: "Countdown to Closing: Buyers", subject: "You're Firm! Closing Info for %property_address%", body: `<p>Hi %contact_rels_first_name%,</p><p>Congratulations, you are officially firm and soon to be homeowners! So excited for you. Here is everything you need to know heading into closing.</p><p><strong>Closing Date</strong></p><p>[CLOSING DATE]</p><p><strong>Financing</strong></p><p>Please send a copy of the accepted offer and Notice of Fulfillment to your mortgage broker. You will need to coordinate signing your final mortgage documents with your lender before closing. They send the mortgage instructions to your lawyer.</p><p><strong>Lawyer Meeting</strong></p><p>You will need to sign the final paperwork with your lawyer and bring a bank draft for your closing costs. Your lawyer will confirm the exact amount. If you need a recommendation: [LAWYER NAME AND CONTACT]</p><p><strong>Home Insurance</strong></p><p>Make sure you have home and car insurance in place. If you need a recommendation, [YOUR INSURANCE RECOMMENDATION].</p><p><strong>Buyer Visits</strong></p><p>You are entitled to [2 or 3] buyer visits before closing. Book the last one for the day before to check all appliances and chattels. Let me know right away if anything is not working.</p><p><strong>Change of Address and Other Reminders</strong></p><ul><li>Canada Post, Service Ontario, banks, subscriptions</li><li>Register children at local schools if applicable</li><li>Notify landlord if currently renting</li></ul><p><strong>Your New Address</strong></p><p>[# Street Name], [City], ON [Postal Code]</p><p>So excited for you. Almost there!</p><p>Talk soon,<br>%agent_first_name% %agent_last_name%<br>%agent_phone%<br>%agent_email%</p>` },
    ...
    { name: "Offer Presentation Reminder", subject: "Offer Presentation Tonight: %property_address%", body: `<p>Hi [AGENT NAME],</p><p>Thank you for showing [ADDRESS] to your clients. Please see the details below for the offer presentation.</p><p><strong>Offer Presentation</strong></p><ul><li>[DAY, DATE] at [TIME]</li><li>Register through Broker Bay with Form 801 by [REGISTRATION DEADLINE]</li><li>Email offer to %agent_email%</li><li>No commission reductions please. Buyer rebates to be arranged separately.</li><li>Please come in with your best offer up front. If offers are close sellers may ask for improvements but this is not guaranteed.</li></ul><p><strong>Possession Date</strong></p><p>[POSSESSION DATE] is ideal</p><p><strong>Required Attachments</strong></p><ul><li>Schedule B and C (attached to the listing)</li><li>Permission to Advertise</li></ul><p><strong>Notes</strong></p><ul><li>Currently [#] offers registered</li><li>Pre-list home inspection available upon request</li><li>Minimum 5% deposit by bank draft payable to [BROKERAGE NAME] or wire transfer to trust account</li></ul><p><strong>Inclusions</strong></p><p>[LIST INCLUSIONS]</p><p><strong>Exclusions</strong></p><p>[LIST EXCLUSIONS]</p><p><strong>Rentals</strong></p><p>[LIST RENTALS OR None]</p><p>%agent_first_name% %agent_last_name% | %agent_phone% | %agent_email%</p>` },
